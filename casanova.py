...
def wishMe():
    ...
    speak("You can book your room by following the bellow procedure..")
...
def Booking():
    ...
    print(" 4. 3-Bed AC")
    print("\t\tPress 0 for Room Prices/day")
    ...
    speak("Please complete further requirement")
    print("Room No. - ", rn)
